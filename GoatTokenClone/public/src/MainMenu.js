class MainMenu extends Phaser.Scene {
    ...
    create() {
        ...
        // title.setOrigin(0.5);
        var titleFont = { font: '80px '+EPT.text['FONT'], fill: '#ffde00', stroke: '#000', strokeThickness: 15 };
        ...
        this.tweens.add({targets: textTitleFont, angle: textTitleFont.angle-12, duration: 600, ease: 'Sine.inOut' });
        this.tweens.add({targets: textTitleFont, angle: textTitleFont.angle+14, duration: 1200, ease: 'Sine.inOut', yoyo: true, repeat: -1, delay: 500 });

        this.buttonSettings = new Button(20, 20, 'button-settings', this.clickSettings, this);
        this.buttonSettings.setOrigin(0, 0);

        var buttonEnclave = new Button(20, EPT.world.height, 'logo-enclave', this.clickEnclave, this, 'static');
        buttonEnclave.setOrigin(0, 1);
        buttonEnclave.setScale(0.5);
